...
export default new Router({
  ...
  routes: [
    ...
    },
    {
      ...
      component: () =>
        import(/* webpackChunkName: "build-profile" */ "./views/BuildProfile.vue")
    },
    {
      ...
      component: () =>
        import(/* webpackChunkName: "discover-dishes" */ "./views/DiscoverDishes.vue")
    },
    {
      ...
      component: () =>
        import(/* webpackChunkName: "discover-places" */ "./views/DiscoverPlaces.vue")
    },
    {
      path: "/other-profile",
      name: "other-profile",
